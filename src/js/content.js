...
var ZONC = {
        ...
        removeCommentsModerated: (selector) => {
        ...
        removeCommentsBlacklisted: (selector) => {

            // // todo: remove first comment and keep subcomment toggler
            // $(selector).find('.comment-meta__name').find(ZONC.blacklistCss).closest('article.comment').not('[data-ct-column="1"]').remove();
